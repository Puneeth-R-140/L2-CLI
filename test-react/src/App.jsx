                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-white/20">
                        ...
                        {isConnected ? (
                            <div className="space-y-6">
                                ...
                                <div className="bg-blue-500/20 border border-blue-400/30 rounded-xl p-4">
                                    <p className="text-blue-100 text-sm">
                                        <strong className="text-white">Tip:</strong> This is a starter template.
                            ...
                            <div className="text-center py-12">
                                <div className="mb-6">
                                    <svg className="w-24 h-24 mx-auto text-blue-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <p className="text-blue-200 mb-6">
                                    Get started by connecting your wallet to Base
                                </p>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-blue-200 text-sm">
                            Built with L2 CLI • Powered by Base
                        </p>
                    </div>
                </div>
            </div>
